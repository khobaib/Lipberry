...
public class CustomAdapterForComment extends BaseAdapter {
	...
	public CustomAdapterForComment(Activity activity, ArrayList<Comments> list, String url, int form,
			FragmentArticleDetailsFromHome lisenar1, FragmentArticleDetailsFromCategory lisenar2,
			FragmentArticleDetailsFromInteraction lisenar3) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.comments_inflate, parent, false);
			...
			// holder.img_report_abuse=(ImageView)
			// convertView.findViewById(R.id.img_report_abuse);
		...
		holder.img_like.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if (!list.get(position).getlikeommentFlag()) {
					...
					Toast.makeText(activity, activity.getResources().getString(R.string.txt_already_liked),
