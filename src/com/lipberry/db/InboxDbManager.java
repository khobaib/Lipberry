...
public class InboxDbManager {
	...
	private static String TABLE_EDUCATION_LIST = "article_list_table2";
	...
	public static List<Article> retrieve(SQLiteDatabase db,List<LikeMember>likeMemberslistAll) throws SQLException {
		...
		if(c != null && c.getCount() > 0){
			...
			while(!c.isAfterLast()){
				...
				Article article=new Article(likedmemberlist, article_id_local, article_photo_local, article_url_local,
						article_title_local,article_description_local, like_count_local, comment_count_local,like_url_local,
						dislike_url_local,comment_url_local,member_id_local,member_photo_local,userAlreadylikeThis_local
