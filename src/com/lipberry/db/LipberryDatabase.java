...
public class LipberryDatabase {
    ...
    //   
    //ArticleFollowingDbManager.createTable(db);
    //LikedMemberDbManagerFollowing.createTable(db);
    ...
    public List<Article> retrieveArticleList() {
    	...
    	for(int i=0;i<likeMemberslist.size();i++){
    		Log.i("i", likeMemberslist.get(i).getMemberUrl()+" "+likeMemberslist.get(i).getNickname());
    	}
