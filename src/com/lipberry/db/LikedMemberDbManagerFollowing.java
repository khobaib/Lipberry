...
public class LikedMemberDbManagerFollowing {
  ...
  /*  private static final String CREATE_TABLE_EDUCATION_LIST = "create table " + TABLE_EDUCATION_LIST + " ( "
    		...
    		+ foreign_key_article_id + "text, " 
            + nickname + " text, "
               + member_url + " text);";*/
    
    
    private static final String CREATE_TABLE_EDUCATION_LIST = "create table " + TABLE_EDUCATION_LIST + " ( "
            + TABLE_PRIMARY_KEY + " integer primary key autoincrement, " + foreign_key_article_id + " text, " + nickname + " text , " + member_url + " text);";
