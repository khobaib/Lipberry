...
public class Splash1Activity extends Activity {
			...
			public void run() {
				if (!appInstance.isRememberMe()) {
					...
					if (Constants.isOnline(Splash1Activity.this)) {
						...
						Toast.makeText(Splash1Activity.this, getResources().getString(R.string.Toast_check_internet),
	...
	public void signin() {
		if (Constants.isOnline(Splash1Activity.this)) {
			if (Constants.isValidEmail(username)) {
				...
				if (!Constants.namecheck(username)) {
					...
					if (username.length() < 3) {
						Toast.makeText(Splash1Activity.this,
								getResources().getString(R.string.txt_uname_cant_lessthan), Toast.LENGTH_SHORT).show();
					}
			...
			Toast.makeText(Splash1Activity.this, getResources().getString(R.string.Toast_check_internet), Toast.LENGTH_LONG).show();
		}
	}
	...
	public void setUsercredential(String result) {
		...
		try {
			...
			if (status.equals("success")) {
				...
				startActivity(intent);
				finish();
				// 05-25 18:10:26.596: D/JsonParser(28549): sb =
				// {"status":"failure","description":"Inactive email"}
	...
	public void resenlinktomail() {
		...
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Splash1Activity.this);
		alertDialogBuilder.setTitle(getResources().getString(R.string.app_name_arabic));
		alertDialogBuilder.setMessage(getResources().getString(R.string.txt_resend_aciviation)).setCancelable(false)
